...
public class StorageService {
    ...
    public UploadResponseDTO createUploadPresignTicket(UploadRequestDTO file) {
        ...
        return new UploadResponseDTO(key, s3Template.createSignedPutURL(bucketName, key, Duration.ofDays(expiresIn), null, file.getContentType()).toString(), expiresIn.toString());
    }
    ...
    public String getUrl(String key) {
        return s3Template.createSignedGetURL(bucketName, key, Duration.ofDays(expiresIn)).toString();
    }
}
