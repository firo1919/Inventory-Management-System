...
export default function DashboardOverview() {
  ...
  return (
    <div className="space-y-8">
      {/* WELCOME BANNER */}
      <WelcomeBanner userName={user?.name || "User"} lowStockCount={stats.lowStockCount} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <TransactionsAnalytics salesCount={stats.salesCount} restocksCount={stats.restocksCount} />

        {/* LOW STOCK ALERT PANEL */}
        <LowStockWarnings products={lowStockProducts} loading={loading} />
      </div>

      {/* RECENT TRANSACTION LIST */}
      <RecentActions transactions={recentTransactions} loading={loading} />
    </div>
  );
}
