...
export default function CategoriesPage() {
    ...
    const effectiveTotalElements = search.trim()
        ? displayedCategories.length
        : totalElements;
    const effectiveTotalPages = search.trim()
        ? Math.ceil(displayedCategories.length / pageSize) || 1
        : totalPages;
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-xs text-slate-400">
                        Classify your products and manage stock divisions
                    </p>
                </div>
                {isAdmin && (
                    <button
            ...
            <CategoryFormModal
                ...
                initialData={
                    selectedCategory ? { name: selectedCategory.name } : null
                }
                loading={modalLoading}
                title="Edit Category"
