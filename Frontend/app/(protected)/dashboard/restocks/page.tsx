...
export default function RestocksPage() {
    ...
    // Selected Restock
    const [selectedRestock, setSelectedRestock] = useState<Restock | null>(
        null,
    );
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-xs text-slate-400">
                        View and record all inward incoming restocks for catalog
                        products
                    </p>
                </div>
                <button
