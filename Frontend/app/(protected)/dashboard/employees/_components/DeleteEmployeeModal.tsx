  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="text-center">
        ...
        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Delete Employee</h3>
        <p className="text-xs text-slate-400 mb-6">
          Are you sure you want to delete <span className="font-semibold text-slate-700 dark:text-white">{employeeName}</span>? This action is permanent and will remove access for this employee.
        </p>
